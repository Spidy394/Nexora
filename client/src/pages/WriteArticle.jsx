...
const WriteArticle = () => {
  const articleLenght = [
    {
      length: 800,
      text: "Short (500-800 workds)",
    },
    {
      length: 800,
      text: "Medium (800-1200 workds)",
    },
    {
      length: 1200,
      text: "Long (1200+ workds)",
    },
  ];

  const [selectedLenght, setSeclectedLength] = useState(articleLenght[0]);
      ...
      >
        ...
        <div className="mt-3 flex gap-3 flex-wrap sm:max-w-9/11">
          {articleLenght.map((item, index) => (
            <span
              onClick={() => setSeclectedLength(item)}
              key={index}
